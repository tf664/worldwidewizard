<script lang="ts">
    ...
    // Clean up any remaining connections when app closes/navigates away
    onDestroy(() => {
        console.log('Layout destroyed, cleaning up socket connections');
        socketService.disconnect();
    });

    // Also clean up on page unload (browser close/refresh)
